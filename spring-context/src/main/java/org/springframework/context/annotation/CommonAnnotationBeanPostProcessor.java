...
public class CommonAnnotationBeanPostProcessor extends InitDestroyAnnotationBeanPostProcessor
    ...
    public PropertyValues postProcessProperties(PropertyValues pvs, Object bean, String beanName) {
        ...
        try {
            /**
             * 就是遍历 {@link InjectionMetadata#injectedElements} 进行注入
             * */
    ...
    protected Object autowireResource(BeanFactory factory, LookupElement element, @Nullable String requestingBeanName)
        ...
        /**
         * 默认的BeanFactory 是这个 DefaultListableBeanFactory，
         * DefaultListableBeanFactory 继承 AutowireCapableBeanFactory、ConfigurableBeanFactory
         *
         * Tips: 这里就是 byName 再 byType的逻辑，也就是先根据name找，找不到就根据类型注入
         * */
        if (factory instanceof AutowireCapableBeanFactory) {
            AutowireCapableBeanFactory beanFactory = (AutowireCapableBeanFactory) factory;
            DependencyDescriptor descriptor = element.getDependencyDescriptor();
            // BeanFactory中没有beanName，就通过类型注入
    ...
    private class ResourceElement extends LookupElement {
        ...
        protected Object getResourceToInject(Object target, @Nullable String requestingBeanName) {
            /**
             * 是@Lazy就创建代理对象，用的时候在执行 {@link CommonAnnotationBeanPostProcessor#getResource(LookupElement, String) }
             * this.lazyLookup 是在构造器的时候解析设置的
             * */
