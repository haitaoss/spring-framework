...
public class InitDestroyAnnotationBeanPostProcessor
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
         ...
         * LifecycleMetadata 其实就是记录了 @PostConstruct、@PreDestroy 的方法
         * */
        LifecycleMetadata metadata = findLifecycleMetadata(bean.getClass());
        try {
            /**
             * 回调方法 {@link LifecycleMetadata#initMethods} 就是 @PostConstruct 标注的方法
             * */
    ...
    private LifecycleMetadata buildLifecycleMetadata(final Class<?> clazz) {
        /**
         * 在构造器设置的 {@link org.springframework.context.annotation.CommonAnnotationBeanPostProcessor#CommonAnnotationBeanPostProcessor()}
         * 就是这两个注解 @PostConstruct、@PreDestroy
         * */
        ...
        /**
         * do...while 循环，递归父类，找到有 @PostConstruct、@PreDestroy 的方法 记录成 LifecycleElement
         * */
        do {
