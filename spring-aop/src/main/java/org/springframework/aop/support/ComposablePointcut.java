...
public class ComposablePointcut implements Pointcut, Serializable {
    ...
    public ComposablePointcut union(Pointcut other) {
        /**
         * 两种匹配方式：
         *  其中一个匹配就行 {@link MethodMatchers.UnionMethodMatcher#matches(Method, Class, Object...)}
         *  根据class找到对应的MethodMatcher匹配，就是指定匹配 {@link MethodMatchers.UnionMethodMatcher#matches(Method, Class)}
         * */
