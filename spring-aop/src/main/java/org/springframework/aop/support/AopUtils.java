...
public abstract class AopUtils {
    ...
    public static boolean isCglibProxy(@Nullable Object object) {
        return (object instanceof SpringProxy && object.getClass()
                .getName()
                .contains(ClassUtils.CGLIB_CLASS_SEPARATOR));
    }
    ...
    public static boolean isFinalizeMethod(@Nullable Method method) {
        return (method != null && method.getName()
                .equals("finalize") && method.getParameterCount() == 0);
    }
    ...
    /**
     * 1. 匹配 targetClass 是否满足 {@link Pointcut#getClassFilter()}
     *      不匹配，直接返回false
     * 2. {@link Pointcut#getMethodMatcher()} 是否是 {@link MethodMatcher.TRUE}
     *      是，直接返回true
     * 3. 匹配 targetClass 的所有方法 是否满足 {@link IntroductionAwareMethodMatcher#matches(Method, Class, boolean)}
     *      只要之中一个满足，就返回true
     *
     * 4. 返回false
     *
    ...
    /**
     * 1. advisor instanceof IntroductionAdvisor true
     *      类匹配满足 就行
     * 2. advisor instanceof PointcutAdvisor
