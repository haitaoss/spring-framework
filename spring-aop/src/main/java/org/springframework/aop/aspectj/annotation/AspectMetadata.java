...
public class AspectMetadata implements Serializable {
    ...
    public AspectMetadata(Class<?> aspectClass, String aspectName) {
         ...
         * 这里是处理 注解的参数信息的
         * */
        switch (this.ajType.getPerClause()
                .getKind()) {
            case SINGLETON:
                // @Aspect() 啥都不写，就是匹配这个case
            ...
            case PERTYPEWITHIN:
                ...
                return;
            default:
                throw new AopConfigException("PerClause " + ajType.getPerClause()
                        .getKind() + " not supported by Spring AOP for " + aspectClass);
        }
    }
    ...
    private String findPerClause(Class<?> aspectClass) {
        String str = aspectClass.getAnnotation(Aspect.class)
                .value();
    ...
    public boolean isPerThisOrPerTarget() {
        PerClauseKind kind = getAjType().getPerClause()
                .getKind();
