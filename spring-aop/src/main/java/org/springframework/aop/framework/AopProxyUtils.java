...
public abstract class AopProxyUtils {
    ...
    public static Class<?> ultimateTargetClass(Object candidate) {
        ...
        if (result == null) {
            result = (AopUtils.isCglibProxy(candidate) ? candidate.getClass()
    ...
    /**
     * 如果接口里面没有 SpringProxy、Advised、DecoratingProxy 的子类，就添加这三个类型 <br/>
    ...
    static Class<?>[] completeProxiedInterfaces(AdvisedSupport advised, boolean decoratingProxy) {
        ...
        /**
         * 属性 {@link AdvisedSupport#interfaces} 没有接口 SpringProxy、Advised、DecoratingProxy，就添加到代理集合中
         *
         * 就是补全 proxiedInterfaces
         * */
    ...
    public static Class<?>[] proxiedUserInterfaces(Object proxy) {
        Class<?>[] proxyInterfaces = proxy.getClass()
                .getInterfaces();
    ...
    public static boolean equalsInProxy(AdvisedSupport a, AdvisedSupport b) {
        return (a == b || (equalsProxiedInterfaces(a, b) && equalsAdvisors(a, b) && a.getTargetSource()
