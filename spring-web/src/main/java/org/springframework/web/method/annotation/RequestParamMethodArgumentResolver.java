...
public class RequestParamMethodArgumentResolver extends AbstractNamedValueMethodArgumentResolver implements UriComponentsContributor {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        if (parameter.hasParameterAnnotation(RequestParam.class)) {
            ...
            if (MultipartResolutionDelegate.isMultipartArgument(parameter)) {
                ...
                // 解析常见的数据类型（基本数据类型、包装类、Map、List这些）
    ...
    protected void handleMissingValueInternal(String name, MethodParameter parameter, NativeWebRequest request,
        ...
        if (MultipartResolutionDelegate.isMultipartArgument(parameter)) {
            ...
            throw new MissingServletRequestParameterException(name, parameter.getNestedParameterType()
                    .getSimpleName(), missingAfterConversion);
        }
    }
    ...
    public void contributeMethodArgument(MethodParameter parameter, @Nullable Object value,
        ...
        RequestParam requestParam = parameter.getParameterAnnotation(RequestParam.class);
        String name = (requestParam != null && StringUtils.hasLength(
                requestParam.name()) ? requestParam.name() : parameter.getParameterName());
        ...
        if (value == null) {
            if (requestParam != null && (!requestParam.required() || !requestParam.defaultValue()
