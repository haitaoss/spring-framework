...
public class UrlPathHelper {
    ...
    public String getPathWithinApplication(HttpServletRequest request) {
        /**
         * 比如：http://localhost:8080/mvc/index
         * */
        // 拿到web应用的项目名。 /mvc
        String contextPath = getContextPath(request);
        // 拿到请求路径，就是端口后面的路径字符串  /mvc/index
        String requestUri = getRequestUri(request);
        // 减掉项目名，也就是拿到具体请求的资源  /index
    ...
    public String getOriginatingQueryString(HttpServletRequest request) {
        if ((request.getAttribute(WebUtils.FORWARD_REQUEST_URI_ATTRIBUTE) != null) || (request.getAttribute(
                WebUtils.ERROR_REQUEST_URI_ATTRIBUTE) != null)) {
    ...
    public String removeSemicolonContent(String requestUri) {
        return (this.removeSemicolonContent ? removeSemicolonContentInternal(requestUri) : removeJsessionid(
                requestUri));
    }
    ...
    private String removeJsessionid(String requestUri) {
        ...
        int index = requestUri.toLowerCase()
                .indexOf(key);
        if (index == -1) {
            return requestUri;
        }
    ...
    private boolean shouldRemoveTrailingServletPathSlash(HttpServletRequest request) {
        ...
        if (flagToUse == null) {
            ...
            try {
                ...
                Properties prop = (Properties) cl.getMethod(methodName)
                        .invoke(null);
    ...
    private static class Servlet4Delegate {
        ...
        public static boolean skipServletPathDetermination(HttpServletRequest request) {
            ...
            return (match != null && (!match.equals(MappingMatch.PATH) || mapping.getPattern()
                    .equals("/*")));
        }
    }
